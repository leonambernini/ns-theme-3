...
$grid-border-color: {{ settings.grid_border_color }};
...
$bg-mini-banners: {{ settings.bg_mini_banners }};
$bg-showcase-two: {{ settings.bg_showcase_two }};
...
.section-home-mini-banners{
  background: $bg-mini-banners;
  padding-bottom: 50px;
}

.section-home-mini-banners-two{
  margin-bottom: 50px;;
}

.section-home-bg{
  background: $bg-showcase-two;
