...
$(document).ready(function(){
	...
	{% if template == 'home' %}
        ...
        var homeSwiper = new Swiper ('.js-home-slider', {
            ...
            on: {
                init: function () {
                  ...
                  $(".js-home-slider").css({"visibility" : "visible"});
                },
            },
        });
        ...
        {% if sections.primary.products or sections.secondary.products %}
	...
	{% set has_banner_services = ( template == 'home' and settings.banner_services ) or ( ( template == 'category' or template == 'search' ) and settings.banner_services_category ) or ( template == 'product' and settings.banner_services_product ) or ( ( template != 'home' and template != 'product' and template != 'category' and template != 'search' ) and settings.banner_services_pages ) %}
	...
	{% if template == 'product' %}
	    ...
	    {# /* // Product slider */ #}
            ...
            {% if settings.product_images_thumbs %}
                var productSwiperThumb = new Swiper ('.js-swiper-product-thumbs', {
                    lazy: true,
                    loop: false,
                    slidesPerView: 4,
                    navigation: {
                        nextEl: '.js-swiper-product-thumb-next',
                        prevEl: '.js-swiper-product-thumb-prev',
                    },
                    on: {
                        init: function () {
                            $(".js-swiper-product-thumbs").css({"visibility" : "visible" , "height" : "auto"});
                        },
                    },
                });
            {% endif %}
    ...
    $('.footer-navs-hide-mobile .js-footer-mobile-title').click( function(){
