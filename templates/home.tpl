...
{% for section in ['home_order_position_1', 'home_order_position_2', 'home_order_position_3', 'home_order_position_4', 'home_order_position_5', 'home_order_position_6', 'home_order_position_7'] %}
    ...
    {% if section_select not in newArray %}
		...
		{% elseif section_select == 'products_two' %}
	        ...
	        {#  **** Featured products ****  #}
			{% include 'snipplets/home/home-featured-products.tpl' with { 'products': sections.secondary.products, 'title': settings.secondary_products_title, 'show_bg': true } %}

		{% elseif section_select == 'about_us' and 1 == 2 %}

			{% include 'snipplets/home/home-about-us.tpl' %}
		
		{% elseif section_select == 'mini_banners' %}

			{% include 'snipplets/home/home-mini-banners.tpl' %}
		
		{% elseif section_select == 'mini_banners_two' %}

			{% include 'snipplets/home/home-mini-banners-two.tpl' %}
